...
<body>
	...
	<div>
	    ...
	    <a href="Controller?command=Localization&lang=en&page=gotoaddnewspage" style=" float: right; margin-right:40px; "><img src="img/eng.png"/></a> 
		<a href="Controller?command=Localization&lang=ru&page=gotoaddnewspage" style="float: right; margin-right:20px;"><img src="img/ru.png"/></a>
	</div>	
	<br />
		...
		<div class="container">
			...
			<form action="Controller" method="post">
				<font size="4"><p align="justify">
						...
						<c:out value="${news_title}"/><br /><input type="text" name="title" value="" /> 
						<c:out value="${brief}"/><br /> <input	type="text" name="brief" value="" /> 
						<c:out value="${content}"/><br /> <input maxlength="1000" type="text" name="content" value="" /> 
						<c:out value="${date}"/><br />	<input maxlength="1000" type="text" placeholder="${date_show}" name="date" value="" />
						<c:if test="${sessionScope.notice eq \"error\" }">
					    <p align="left"><c:out value="${date_format}"/></p>					
				        </c:if>
